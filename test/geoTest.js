...
const PlasticGeoDistance_1 = require("../PlasticGeoDistance");
...
describe('PlasticGeoDistance', () => {
    ...
    const sampleLoc = {
        ...
        billings: { lat: 45.7589, lng: -108.483 },
        bozeman: { lat: 45.6751, lng: -111.0428 },
        fiji: { lat: -17.7798, lng: 177.8037 },
        amsam: { lat: -14.2822, lng: -170.7314 },
        mcmurdo: { lat: -77.8431, lng: 166.6879 },
        southnz: { lat: -45.7854, lng: 168.5981 } // Southern New Zealand, random pt near Lumsden
    };
    const reallyClose = (a, b, closeness) => {
        const clsns = closeness && closeness > 0 ? closeness : 0.0005;
        return Math.abs(1 - (b != 0 ? a / b : (a + 1) / (b + 1))) < clsns;
    };
    beforeEach(function () {
        pgdM = new PlasticGeoDistance_1.default('M');
        pgdK = new PlasticGeoDistance_1.default('K');
    });
    describe('Conversions', () => {
        it('Should convert lat/lng to/from radians', () => {
            let result = pgdM.geoToDegrees(pgdM.geoToRadians({ lat: 36.12547, lng: -115.07517 }));
    ...
    describe('Geographic Center', () => {
        ...
        it('should calculate correct center for 7 points', () => {
            const correct = { lat: -1.360479, lng: -151.884239 };
            let center = pgdM.computeMidpoint([
                sampleLoc.billings,
                sampleLoc.bozeman,
                sampleLoc.butte,
    ...
    describe('Center of distance', () => {
        it('should be at least as close as the center of a bounding rectangle', () => {
            let correct = { lat: 46.089779, lng: -112.5348 };
        ...
        it('should calculate correct center for three points', () => {
            const correct = { lat: 45.6751, lng: -111.0428 };
        ...
        it('should calculate correct center for 7 points', () => {
            const correct = { lat: -14.282199, lng: -170.731399 };
            let center = pgdM.computeMinimumDistancePoint([
                sampleLoc.billings,
                sampleLoc.bozeman,
                sampleLoc.butte,
...
//# sourceMappingURL=geoTest.js.map